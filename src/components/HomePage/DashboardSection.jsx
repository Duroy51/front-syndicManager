    ...
    <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg shadow-lg p-8 text-white">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold mb-2">Créez votre propre syndicat</h2>
                    <p className="text-blue-100">Lancez votre propre syndicat et rassemblez des membres autour de votre cause.</p>
                </div>
