...
export const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-purple-50">
            {/* Header */}
            <header className="bg-white/70 backdrop-blur-md shadow-md py-4 sticky top-0 z-50">
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid gap-8 md:grid-cols-3">
                            <div className="text-center">
                                <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-full p-4 inline-block mb-4 shadow-lg">
                            ...
                            <div className="text-center">
                                <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-full p-4 inline-block mb-4 shadow-lg">
                            ...
                            <div className="text-center">
                                <div className="bg-gradient-to-br from-blue-400 to-purple-400 rounded-full p-4 inline-block mb-4 shadow-lg">
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid gap-8 md:grid-cols-4">
                            {statistics.map((stat) => (
                                <motion.div
                                    key={stat.id}
                                    className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-2xl transition-all duration-300"
                                    whileHover={{
                                        y: -5,
